...
const CustomAlert = ({ handleContactScroll }) => {
  ...
  return (
    showAlert &&
    <div onClick={handleClickAlert} className={`transition-all duration-300 ease-out hover:scale-105 text-center py-4 lg:px-4 w-100 fixed bottom-5 z-50`}>
      <div className="custom-drop p-3 bg-slate-100 items-center text-indigo-100 leading-none rounded-full flex lg:inline-flex" role="alert">
